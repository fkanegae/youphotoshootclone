      ...
      <div className="max-w-section mx-auto px-section">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <FaqItem
            ...
            answer="We don't cut corners when it comes to generating photorealistic AI headshots. We're not the fastest, but you'll always get same-day results with YouPhotoshoot. Our Executive package is delivered in 1 hour or less."
          />
          <FaqItem
            question="What do people misunderstand about AI headshots?"
            answer="Not every photo is perfect. Due to the nature of AI, you might see some strange photos. YouPhotoshoot tries to make this clear from the start: not every photo is perfect, but we promise you'll find a profile-worthy headshot in every order to make it all worth it."
          />
          <FaqItem
          ...
          <FaqItem
            ...
            answer="Yes, YouPhotoshoot has a 100% free AI headshot generator for simple photos. No email is required and no credit card is required. It is completely free."
          />
          <FaqItem
          ...
          <FaqItem
            ...
            answer="25% of YouPhotoshoot customers use their AI headshots on LinkedIn. It's totally okay to use AI headshots on LinkedIn."
          />
          <FaqItem
            question="Can ChatGPT generate headshots?"
            answer="Yes, ChatGPT can generate very basic headshots. These headshots aren't realistic enough to use professionally, but they can be fun to play around with. Use YouPhotoshoot for AI headshots you can use professionally."
          />
          <FaqItem
            question="What AI should I use for headshots?"
            answer="The best AI headshot generators are using Flux to maximize realism. Right now, YouPhotoshoot is the only major headshot AI powered by Flux. You can get up to 200 professional AI headshots within 2 hours"
          />
        </div>
      </div>
    </section>
